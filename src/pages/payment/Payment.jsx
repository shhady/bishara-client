        ...
        <div className="popup-overlay">
          <div className="popup-container">
            ...
            style={{height:"100vh",width:"100vw"}}
              ...
              src={`${process.env.REACT_APP_PAYMENT_URL}?codepage=${process.env.REACT_APP_CODE_PAGE}&Operation=1&TerminalNumber=${process.env.REACT_APP_TERMINAL}&UserName=${process.env.REACT_APP_USER_NAME}&SumToBill=${period === "year" ? 1500 : period === "6 months" ? 1194 : 690}
