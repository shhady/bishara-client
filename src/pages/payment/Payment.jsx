      ...
      <div className="popup-overlay">
        <div className="popup-container">
          <iframe
            ...
            src={`${process.env.REACT_APP_PAYMENT_URL}?codepage=${process.env.REACT_APP_CODE_PAGE}&Operation=1&TerminalNumber=${process.env.REACT_APP_TERMINAL}&UserName=${process.env.REACT_APP_USER_NAME}&SumToBill=${period === "year" ? 1 : period === "6 months" ? 1194 : 690}
              &CoinID=1&Language=ar&ProductName=item1&APILevel=10&SuccessRedirectUrl=https://secure.cardcom.solutions/SuccessAndFailDealPage/Success.aspx&ErrorRedirectUrl=https://secure.cardcom.solutions/SuccessAndFailDealPage/Fail.aspx&IndicatorUrl=www.google.com&ReturnValue=1234&&AutoRedirect=true&InvoiceHead.CustName=${user.firstName}&InvoiceHead.SendByEmail=true&InvoiceHead.Email=${user.email}&InvoiceHead.Language=ar&InvoiceHead.CoinID=1&CardOwnerEmail=${user.email}&MaxNumOfPayments=${period === "year" ? 12 : period === "6 months" ? 6 : 3}&InvoiceLines1.Description=${period === 'year' ? "سنة" : period === "6 months" ? "6 اشهر":"3 اشهر"}&InvoiceLines1.Price=${period === "year" ? 1 : period === "6 months" ? 1194 : 690}&InvoiceLines1.Quantity=1`}
            title="Cardcom Popup"
          />
        </div>
      </div>
