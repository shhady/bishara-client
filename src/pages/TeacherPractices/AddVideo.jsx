  ...
  useEffect(() => {
    const fetchReplies = async () => {
      try {
        ...
        setAutoReplies(getReplies.data.filter(replies => replies.uniqueLink === practice.uniqueLink && replies.nameOfProblem || !replies.uniqueLink && !practice.uniqueLink && replies.nameOfProblem || replies.uniqueLink === "general" ));
