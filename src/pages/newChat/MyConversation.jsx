...
export default function MyConversation({currentUser, conversation}) {
  ...
  <div className='conversationsList'>
        ...
        <div className='UnSeenMessage'>
            ...
            {conversation.seen === 'true' || conversation.lastSender == currentUser._id  ? (<Link to={`/chatting?currentChat=${conversation._id}&to=${user?._id}&from=${currentUser._id}`} style={{textDecoration:"none" ,color:"black"}}><div className='conversationsList'>
            <div className='conversation1'>
